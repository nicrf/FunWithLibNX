...
#if LV_MEM_CUSTOM == 0
#define LV_MEM_SIZE    (128U * 1024U)        /*Size memory used by `lv_mem_alloc` in bytes (>= 2kB)*/
...
#define LV_VDB_SIZE         (72 * LV_HOR_RES)  /*Size of VDB in pixel count (1/10 screen size is good for first)*/
